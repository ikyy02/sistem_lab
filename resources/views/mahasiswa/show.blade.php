...
@section('page-subtitle', 'Informasi lengkap data mahasiswa.')
    ...
    <div class="col-12 col-lg-7 col-xl-6">
        <div class="card-modern overflow-hidden">
            ...
            <div class="px-4 py-3 d-flex align-items-center gap-3" style="border-bottom:1px solid #e2e8f0; background:#fafafa;">
                ...
                <div>
                    <div class="fw-bold" style="font-size:0.95rem; color:#1e293b;">{{ $mahasiswa->nama }}</div>
                    <div style="font-size:0.75rem; color:#64748b;">Detail informasi mahasiswa</div>
                </div>
            </div>
            ...
            <div class="p-4">
                <div class="mb-3">
                    <div style="font-size:0.75rem; color:#94a3b8; text-transform:uppercase; letter-spacing:0.04em;">NIM</div>
                    <div style="font-size:0.9rem; color:#1e293b; font-weight:600;">{{ $mahasiswa->nim }}</div>
                </div>
                <div class="mb-3">
                    <div style="font-size:0.75rem; color:#94a3b8; text-transform:uppercase; letter-spacing:0.04em;">Nama</div>
                    <div style="font-size:0.9rem; color:#1e293b; font-weight:600;">{{ $mahasiswa->nama }}</div>
                </div>
                <div class="mb-3">
                    <div style="font-size:0.75rem; color:#94a3b8; text-transform:uppercase; letter-spacing:0.04em;">Program Studi</div>
                    <div style="font-size:0.9rem; color:#1e293b; font-weight:600;">{{ $mahasiswa->program_studi }}</div>
                </div>
                <div class="mb-3">
                    <div style="font-size:0.75rem; color:#94a3b8; text-transform:uppercase; letter-spacing:0.04em;">Email</div>
                    <div style="font-size:0.9rem; color:#1e293b; font-weight:600;">{{ $mahasiswa->email }}</div>
                </div>
                <div class="mb-4">
                    <div style="font-size:0.75rem; color:#94a3b8; text-transform:uppercase; letter-spacing:0.04em;">Nomor WhatsApp</div>
                    <div style="font-size:0.9rem; color:#1e293b; font-weight:600;">{{ $mahasiswa->no_whatsapp }}</div>
                </div>
