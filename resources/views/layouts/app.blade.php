...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        /* ========== ROLE BADGES ========== */
        .badge-mahasiswa   { background:#dbeafe; color:#1d4ed8; border:1px solid #bfdbfe; }
        .badge-dosen       { background:#d1fae5; color:#047857; border:1px solid #a7f3d0; }
        .badge-staf_prodi  { background:#fef3c7; color:#b45309; border:1px solid #fde68a; }
        .badge-laboran     { background:#fee2e2; color:#b91c1c; border:1px solid #fecaca; }
        .badge-aktif       { background:#ecfdf5; color:#047857; border:1px solid #a7f3d0; }
        .badge-nonaktif    { background:#f1f5f9; color:#64748b; border:1px solid #e2e8f0; }

        /* ========== MODERN PAGINATION ========== */
        .pagination-modern .pagination { margin:0; gap:4px; }
...
<div id="main-wrapper">
    ...
    <header id="topbar">
        ...
        <div class="topbar-right">
            <div class="d-none d-sm-flex flex-column align-items-end text-end me-1" style="line-height:1.2;">
                <span style="font-size:0.8rem; font-weight:600; color:#0f172a;">{{ auth()->user()->name }}</span>
                <span class="badge rounded-pill px-2" style="background:#f0fdf4; color:#16a34a; font-size:0.66rem; font-weight:600; border:1px solid #bbf7d0;">
                    {{ strtoupper(auth()->user()->role_label) }}
                </span>
            </div>
            ...
            <form method="POST" action="{{ route('logout') }}">
                ...
                <button type="submit"
                        ...
                        style="background:#fff1f2; color:#e11d48; border:1px solid #fecdd3; border-radius:9px; font-size:0.8rem; font-weight:600; padding:7px 13px; white-space:nowrap;"
                        title="Keluar">
