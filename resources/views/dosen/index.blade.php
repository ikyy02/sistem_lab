...
@section('page-subtitle', 'Kelola data dosen pengguna laboratorium komputer bisnis.')
...
<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
    <div>
        <h2 class="fw-bold mb-1" style="font-size:1.3rem; color:#1e293b;">Kelola Data Dosen</h2>
        <p class="mb-0" style="font-size:0.83rem; color:#64748b;">Kelola data dosen pengguna laboratorium komputer bisnis.</p>
    </div>
    <a href="{{ route('dosen.create') }}" class="btn d-flex align-items-center gap-2" style="background:#16a34a;color:#fff;border-radius:10px;font-size:0.85rem;font-weight:600;padding:9px 18px;white-space:nowrap;">
        ...
        <table class="table table-hover mb-0" style="font-size:0.85rem;">
            <thead style="background:#f8fafc; color:#64748b; font-size:0.75rem; text-transform:uppercase; letter-spacing:0.04em;">
                <tr>
                    ...
                    <th class="py-3 fw-semibold border-0">NIDN</th>
                    <th class="py-3 fw-semibold border-0">NIP</th>
            ...
            @forelse($data as $item)
                <tr style="border-top:1px solid #f1f5f9;">
                    ...
                    <td class="py-3 align-middle" style="color:#475569;">{{ $item->nidn }}</td>

                    <td class="py-3 align-middle" style="color:#475569;">{{ $item->nip ?? '—' }}</td>
                    ...
                    <td class="py-3 pe-4 align-middle text-end">
                        <div class="d-flex align-items-center justify-content-end gap-2">
                            ...
                            <form action="{{ route('dosen.destroy', $item) }}" method="POST" class="d-inline"
                        ...
                        <div class="text-center py-5" style="color:#94a3b8;">
                            <div class="mb-3">
                                <span style="display:inline-flex;align-items:center;justify-content:center;width:64px;height:64px;background:#f1f5f9;border-radius:50%;">
                                    <i class="bi bi-person-badge fs-2" style="color:#cbd5e1;"></i>
                                </span>
                            </div>
                            <div class="fw-semibold mb-1" style="font-size:0.95rem; color:#475569;">Belum ada data</div>
                            <div class="mb-4" style="font-size:0.83rem; color:#94a3b8;">Belum ada data dosen yang tersedia.</div>
                            <a href="{{ route('dosen.create') }}" class="btn d-inline-flex align-items-center gap-2" style="background:#16a34a;color:#fff;border-radius:10px;font-size:0.83rem;font-weight:600;padding:9px 20px;">
