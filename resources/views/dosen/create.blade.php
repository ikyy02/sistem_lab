...
@section('page-subtitle', 'Tambah data dosen baru pengguna laboratorium komputer bisnis.')
    ...
    <div class="col-12 col-lg-7 col-xl-6">
        <div class="card-modern overflow-hidden">
            ...
            <div class="px-4 py-3 d-flex align-items-center gap-3" style="border-bottom:1px solid #e2e8f0; background:#fafafa;">
                ...
                <div>
                    <div class="fw-bold" style="font-size:0.95rem; color:#1e293b;">Tambah Data Dosen</div>
                    <div style="font-size:0.75rem; color:#64748b;">Isi semua field yang diperlukan</div>
                </div>
            </div>

            <!-- Form Body -->
            <form action="{{ route('dosen.store') }}" method="POST" class="p-4">
                @csrf
