...
@section('page-title', 'Edit Alat & Bahan')
@section('page-subtitle', 'Perbarui informasi data alat atau bahan laboratorium komputer bisnis.')
    ...
    <div class="col-12 col-lg-7 col-xl-6">
        <div class="card-modern overflow-hidden">
            ...
            <div class="px-4 py-3 d-flex align-items-center gap-3" style="border-bottom:1px solid #e2e8f0; background:#fafafa;">
                ...
                <div>
                    <div class="fw-bold" style="font-size:0.95rem; color:#1e293b;">Edit: {{ $alatBahan->nama }}</div>
                    <div style="font-size:0.75rem; color:#64748b;">Perbarui informasi data di bawah ini</div>
                </div>
            </div>

            <!-- Form Body -->
            <form action="{{ route('alat-bahan.update', $alatBahan) }}" method="POST" class="p-4">
                @csrf
                @method('PUT')
                ...
                <div class="row g-3 mb-4">
                    <div class="col-6">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('satuan', $alatBahan->satuan) }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="text"
                           ...
                           value="{{ old('kondisi', $alatBahan->kondisi) }}"
                ...
                <div class="mb-4">
                    ...
                    <textarea name="keterangan"
                              ...
                              style="border-radius:10px; border-color:#e2e8f0; font-size:0.87rem; padding:10px 14px; resize:vertical;">{{ old('keterangan', $alatBahan->keterangan) }}</textarea>
                    @error('keterangan')
                        <div class="invalid-feedback d-flex align-items-center gap-1 mt-1" style="font-size:0.78rem;">
                            <i class="bi bi-exclamation-circle-fill"></i> {{ $message }}
                        </div>
